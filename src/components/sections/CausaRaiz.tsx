...
export function CausaRaiz() {
  return (
    <section className="relative overflow-hidden bg-bone py-24 lg:py-32">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-32 top-20 h-[26rem] w-[26rem] rounded-full bg-gold/10 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-24 bottom-10 h-[22rem] w-[22rem] rounded-full bg-gold/8 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
          ...
          <Reveal>
            ...
            <h2 className="mt-6 font-display text-[2rem] font-semibold leading-[1.1] tracking-[-0.02em] text-ink sm:text-[2.75rem] lg:text-[3rem]">
          ...
          <Reveal delay={90}>
            <div className="space-y-8 font-body text-[0.98rem] leading-[1.85] text-graphite">
              <p>
              ...
              <blockquote className="relative overflow-hidden rounded-[var(--radius-card)] border border-line bg-cream/50 p-7 sm:p-9">
                <span
                  aria-hidden
                  className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-gold via-gold-soft to-gold/30"
                />
                <p className="relative font-display text-[1.3rem] font-semibold leading-[1.45] text-ink sm:text-[1.55rem]">
        ...
        <Reveal>
          <div className="mt-16 flex flex-col items-start gap-5 border-t border-line pt-8 sm:flex-row sm:items-center sm:justify-between">
