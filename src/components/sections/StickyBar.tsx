...
export function StickyBar() {
  ...
  return (
    <div
      className={cn(
        "fixed inset-x-0 top-0 z-50 border-b border-gold/15 bg-espresso/95 backdrop-blur transition-all duration-300",
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-2.5 sm:px-8">
        <div className="min-w-0">
          <p className="truncate font-body text-[0.66rem] uppercase tracking-[0.22em] text-gold">
